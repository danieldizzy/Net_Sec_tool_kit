#!/bin/bash
##################################################################################
##Firefox Security Booster
###Description:
#This script automatically transform Firefox Browser to a penetration testing engine. The script mainly focuses on downloading the required addons for web-application penetration testing.
#Credits: Mazin Ahmed 
###Version:
#v0.1
###Homepage:
...
echo -e "        |___/                                                                    "
echo -e "v0.4"
echo -e "\t\t\t\t\twww.sheberwok.com"
echo -e "\t\t\t\t\ttwitter.com/dizzylol4"
echo -e "\n\n"
}
